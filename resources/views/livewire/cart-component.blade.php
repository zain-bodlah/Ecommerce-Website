        ...
        <div class=" main-content-area">
                ...
                <div class="order-summary">
                    ...
                    <div class="checkout-info">
                        ...
                        <label class="checkbox-field">
                            <input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouponCode"><span>I have
                                coupon code</span>
                        </label>
                        @if ($haveCouponCode == 1)
            ...
            @else
                <div class="text-center" style="padding: 30px 0;">
                    ...
                    <a href="/shop" style="text-decoration: none;" class="btn btn-success">Shop Now</a>
                </div>
            @endif
            <div class="wrap-iten-in-cart">
